...
Vals[5]=0x50C6645BU;
Vals[5]+=(rotr(W[2],6)^rotr(W[2],11)^rotr(W[2],25));
Vals[5]+=ch(W[2],W[3],0x510e527fU);
Vals[5]+=Vals[2];

Vals[1]=0xbb67ae85U;
Vals[1]+=Vals[5];
Vals[5]+=(rotr(W[6],2)^rotr(W[6],13)^rotr(W[6],22));
Vals[5]+=Ma2(0x6a09e667U,W[6],W[7]);
...
Vals[4]+=(rotr(Vals[5],2)^rotr(Vals[5],13)^rotr(Vals[5],22));
Vals[4]+=Ma(W[7],Vals[5],W[6]);

W[3]+=(rotr(W[0],6)^rotr(W[0],11)^rotr(W[0],25));
W[3]+=ch(W[0],Vals[1],W[2]);
W[3]+=K[4];
W[3]+=W[4];
W[7]+=W[3];
W[3]+=(rotr(Vals[4],2)^rotr(Vals[4],13)^rotr(Vals[4],22));
W[3]+=Ma(W[6],Vals[4],Vals[5]);

W[2]+=(rotr(W[7],6)^rotr(W[7],11)^rotr(W[7],25));
W[2]+=ch(W[7],W[0],Vals[1]);
W[2]+=K[5];
W[2]+=W[5];
W[6]+=W[2];
W[2]+=(rotr(W[3],2)^rotr(W[3],13)^rotr(W[3],22));
W[2]+=Ma(Vals[5],W[3],Vals[4]);

Vals[1]+=(rotr(W[6],6)^rotr(W[6],11)^rotr(W[6],25));
Vals[1]+=ch(W[6],W[7],W[0]);
Vals[1]+=K[6];
Vals[1]+=Vals[6];
Vals[5]+=Vals[1];
Vals[1]+=(rotr(W[2],2)^rotr(W[2],13)^rotr(W[2],22));
Vals[1]+=Ma(Vals[4],W[2],W[3]);

W[0]+=(rotr(Vals[5],6)^rotr(Vals[5],11)^rotr(Vals[5],25));
W[0]+=ch(Vals[5],W[6],W[7]);
W[0]+=K[7];
W[0]+=Vals[7];
Vals[4]+=W[0];
W[0]+=(rotr(Vals[1],2)^rotr(Vals[1],13)^rotr(Vals[1],22));
W[0]+=Ma(W[3],Vals[1],W[2]);

W[7]+=(rotr(Vals[4],6)^rotr(Vals[4],11)^rotr(Vals[4],25));
W[7]+=ch(Vals[4],Vals[5],W[6]);
W[7]+=0x5807AA98U;
W[3]+=W[7];
W[7]+=(rotr(W[0],2)^rotr(W[0],13)^rotr(W[0],22));
W[7]+=Ma(W[2],W[0],Vals[1]);

W[6]+=(rotr(W[3],6)^rotr(W[3],11)^rotr(W[3],25));
W[6]+=ch(W[3],Vals[4],Vals[5]);
W[6]+=K[9];
W[2]+=W[6];
W[6]+=(rotr(W[7],2)^rotr(W[7],13)^rotr(W[7],22));
W[6]+=Ma(Vals[1],W[7],W[0]);

Vals[5]+=(rotr(W[2],6)^rotr(W[2],11)^rotr(W[2],25));
Vals[5]+=ch(W[2],W[3],Vals[4]);
Vals[5]+=K[10];
Vals[1]+=Vals[5];
Vals[5]+=(rotr(W[6],2)^rotr(W[6],13)^rotr(W[6],22));
Vals[5]+=Ma(W[0],W[6],W[7]);
...
W[1]+=(rotr(Vals[2],7)^rotr(Vals[2],18)^(Vals[2]>>3U));
W[1]+=0x00a00000U;
W[6]+=W[1];
W[6]+=(rotr(W[3],6)^rotr(W[3],11)^rotr(W[3],25));
W[6]+=ch(W[3],Vals[4],Vals[5]);
...
W[4]+=(rotr(W[5],7)^rotr(W[5],18)^(W[5]>>3U));
W[4]+=(rotr(Vals[2],17)^rotr(Vals[2],19)^(Vals[2]>>10U));
W[3]+=W[4];
W[3]+=(rotr(W[0],6)^rotr(W[0],11)^rotr(W[0],25));
W[3]+=ch(W[0],Vals[1],W[2]);
W[3]+=K[20];
...
W[5]+=(rotr(Vals[6],7)^rotr(Vals[6],18)^(Vals[6]>>3U));
...
Vals[6]+=0x00000100U;
Vals[6]+=(rotr(W[4],17)^rotr(W[4],19)^(W[4]>>10U));
Vals[1]+=Vals[6];
Vals[1]+=(rotr(W[6],6)^rotr(W[6],11)^rotr(W[6],25));
Vals[1]+=ch(W[6],W[7],W[0]);
Vals[1]+=K[22];
...
W[10]+=(rotr(W[8],17)^rotr(W[8],19)^(W[8]>>10U));
Vals[5]+=W[10];
Vals[5]+=(rotr(W[6],6)^rotr(W[6],11)^rotr(W[6],25));
Vals[5]+=ch(W[6],W[3],Vals[4]);
Vals[5]+=K[58];
Vals[5]+=Vals[1];
Vals[4]+=(rotr(Vals[5],6)^rotr(Vals[5],11)^rotr(Vals[5],25));
Vals[4]+=ch(Vals[5],W[6],W[3]);
Vals[4]+=W[11];
...
#define NFLAG (0x7F)
	...
	if ((W[7]+
		...
		ch(Vals[4],Vals[5],W[6])) == 0x136032edU)
