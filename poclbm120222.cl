...
Vals[4]+=(rotr(W[5],2)^rotr(W[5],13)^rotr(W[5],22));
Vals[4]+=Ma(W[7],W[5],W[6]);
...
W[4]+=(rotr(Vals[5],7)^rotr(Vals[5],18)^(Vals[5]>>3U));
...
W[5]+=ch(W[6],W[3],Vals[4]);
W[5]+=K[58];
W[5]+=W[1];
Vals[4]+=(rotr(W[5],6)^rotr(W[5],11)^rotr(W[5],25));
Vals[4]+=ch(W[5],W[6],W[3]);
Vals[4]+=W[11];
