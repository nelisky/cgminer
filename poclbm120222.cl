...
Vals[6]+=(0x9b05688cU^(W[3]&0xca0b3af3U));
...
Vals[6]+=Ma2(0xbb67ae85U,W[7],0x6a09e667U);
...
Vals[1]+=Vals[5];
Vals[5]+=(rotr(Vals[6],2)^rotr(Vals[6],13)^rotr(Vals[6],22));
Vals[5]+=Ma2(0x6a09e667U,Vals[6],W[7]);
...
W[6]+=(rotr(Vals[7],7)^rotr(Vals[7],18)^(Vals[7]>>3U));
W[6]+=0x00000100U;
W[6]+=(rotr(W[4],17)^rotr(W[4],19)^(W[4]>>10U));
Vals[1]+=W[6];
Vals[1]+=(rotr(Vals[6],6)^rotr(Vals[6],11)^rotr(Vals[6],25));
...
Vals[5]+=ch(Vals[6],W[3],Vals[4]);
Vals[5]+=K[58];
Vals[5]+=Vals[1];
Vals[4]+=(rotr(Vals[5],6)^rotr(Vals[5],11)^rotr(Vals[5],25));
Vals[4]+=ch(Vals[5],Vals[6],W[3]);
Vals[4]+=W[11];
